...
public class Databasehelper extends SQLiteOpenHelper {
 ...
 // ContentValues is a name value pair,used to get the values from database tables.
 // ContentValues object will be returned from SQLiteDataBase objects query() function.
 // Cursor is a temporary buffer area which will be passed to SQLiteDataBase insert() and update() functions to update table rows.
        ContentValues values = new ContentValues();
